...
import (
	...
	"github.com/gkwa/curioscrime/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.curioscrime.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".curioscrime")
	}
